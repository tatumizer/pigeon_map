...
var _metadata_Stuff = new PigeonStructMetadata(pigeonTypeCatalog,{'type': 'Stuff', 'attributes': [{'type': 'DateTime', 'name': 'dt'}, {'type': 'Float32List', 'name': 'f32'}, {'type': 'Float64List', 'name': 'f64'}, {'type': 'int', 'name': 'i'}, {'type': 'Int16List', 'name': 'i16'}, {'type': 'Int32List', 'name': 'i32'}, {'type': 'Int64List', 'name': 'i64'}, {'type': 'Int8List', 'name': 'i8'}, {'type': 'Uint16List', 'name': 'u16'}, {'type': 'Uint32List', 'name': 'u32'}, {'type': 'Uint64List', 'name': 'u64'}, {'type': 'Uint8List', 'name': 'u8'}, {'type': 'double', 'name': 'x'}]});
class Stuff extends PigeonStruct {
  ...
  Uint16List get u16 => getValue(8);
  void set u16(Uint16List val) => setValue(8,val);
  Uint32List get u32 => getValue(9);
  void set u32(Uint32List val) => setValue(9,val);
  Uint64List get u64 => getValue(10);
  void set u64(Uint64List val) => setValue(10,val);
  Uint8List get u8 => getValue(11);
  void set u8(Uint8List val) => setValue(11,val);
  double get x => getValue(12);
  void set x(double val) => setValue(12,val);
}
